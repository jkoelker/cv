...
{\bf Languages:} & Python, Go, C, C++, Java, C\#, bash, Erlang \\
...
\begin{rSubsection}{D2iQ / Mesosphere}
                   {2018 -- Present} % chktex 8
                   {San Francisco, CA -- Remote} % chktex 8
\begin{rEmptySubsubsection}{Senior Software Engineer -- Kubernetes} % chktex 8
                           {2019 -- present} % chktex 8
\end{rEmptySubsubsection}
...
\item Championed maintance of Marthon-LB\@. Reviewed and merged backlog of
